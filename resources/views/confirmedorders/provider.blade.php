        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card-header" style="text-align:center;color:white;background-color:#301934"><strong>Confirmed Orders</strong></div>
            <div class="card-body">
            <a href="/allonlinepayments" class="btn btn " style="background-color:#301934;color:white;margin-bottom:10px" role="button" aria-pressed="true">Show Online Payments</a>
