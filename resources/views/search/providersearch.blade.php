            ...
            <div class="col-sm-6 col-md-4" style="padding:20px">
              ...
              <div class="card border-white">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text" style="text-align:center;margin-bottom:5px">Provider: {{ $product->provider->username }}</p>
                  ...
                  <p style="text-align:center"><a href="product/{{$product->id}}/providerreview" style="color:indigo">Reviews</a>
                  <form method="POST" action="{{ route('customer.addtocart', $product->id) }}">
                        @csrf
                        <div class="row justify-content-center">
                  <button type="submit" class="btn btn" style="background-color:#301949;color:white">Add to cart</button>
                        </div> 
                </form></p>
